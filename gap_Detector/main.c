/**
 * @file Variadic functions in C.c
 * @author Mohamed Reda (mhmdreda99@github.com)
 * @brief Variadic functions are functions which take a variable number of arguments. In C programming,
 *  a variadic function will contribute to the flexibility of the program that you are developing.
 * in this problem, i will implement three variadic functions named ,sum() , min(),max()  and  to calculate sums, minima, maxima of a variable number of arguments.
